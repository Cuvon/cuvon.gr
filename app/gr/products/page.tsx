...
const areas = [
  {
    label: 'Τμήμα 01',
    title: 'Φαρμακευτικά',
    body: 'Εκεί που η διείσδυση στην αγορά συναντά την επιχειρησιακή αριστεία. Στη Cuvon, συνδυάζουμε στοχευμένες στρατηγικές προώθησης με υψηλής αυστηρότητας αποθήκευση και αναφορά φαρμακευτικών προϊόντων.',
    detail: '',
    highlights: [
  ...
  },
  {
    label: 'Τμήμα 02',
    title: 'OTC',
    body: 'Επιταχύνουμε την ανάπτυξη OTC brands σε όλα τα κορυφαία δίκτυα φαρμακείων της Ελλάδας. Η Cuvon συνδυάζει εξειδικευμένη προωθητική τεχνογνωσία με άψογη διαχείριση αποθεμάτων και ταχύ ανεφοδιασμό — διασφαλίζοντας ότι τα προϊόντα προωθούνται ενεργά στην αγορά και είναι διαθέσιμα στο ράφι.',
    detail: '',
    highlights: [
  ...
  },
  {
    ...
    body: 'Εντοπίζουμε αναξιοποίητες ανάγκες αγοράς και επιταχύνουμε την ανάπτυξη. Στη Cuvon, επιλέγουμε premium συμπληρώματα διατροφής από αξιόπιστους κατασκευαστές και τα υποστηρίζουμε με ισχυρές εμπορικές στρατηγικές.',
    detail: '',
    highlights: [

  ...
  return (
    <>
      <PageHeader
        ...
        lead="Διαχειριζόμαστε μόνο ό,τι μπορούμε να υποστηρίξουμε πλήρως. Κάθε προϊόν στο χαρτοφυλάκιο της Cuvon έχει κερδίσει τη θέση του — αξιολογημένο βάσει πραγματικής ανάγκης αγοράς και υποστηριγμένο πλήρως."
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            <div className="lg:col-span-3">
              ...
              <p className="text-lead text-slate-blue leading-[1.7] mb-5">
                Οι αποφάσεις χαρτοφυλακίου στη Cuvon αξιολογούνται με βάση δύο κριτήρια: πραγματική ανάγκη αγοράς και επιχειρησιακή καταλληλότητα. Προσθέτουμε προϊόντα γιατί ανήκουν εδώ, και διακόπτουμε όσα δεν πληρούν πλέον το πρότυπό μας.
              </p>
              ...
              <div key={a.title} className="bg-white rounded-brand border border-deep-blue/8 shadow-card p-10">
                <div className="flex flex-col lg:flex-row lg:gap-16 gap-8 items-start">
                  ...
                  <div className="flex-1">
                    <p className="text-[0.75rem] font-bold tracking-[0.08em] uppercase text-caption mb-4">Βασικά σημεία</p>

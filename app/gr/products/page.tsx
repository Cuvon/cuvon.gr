...
const areas = [
  ...
  },
  {
    label: 'Κατηγορία 04',
    title: 'Καλλυντικά',
    body: 'Προβολή brand με εμπορική στόχευση και επιχειρησιακή ακρίβεια. Αξιοποιούμε τεχνογνωσία και βαθιά γνώση προϊόντος για να αναδείξουμε το κύρος, να ενισχύσουμε τη ζήτηση και να επιταχύνουμε τις πωλήσεις.',
    detail: '',
    highlights: [
...
export default function GrProductsPage() {
  return (
    <>
      <PageHeader
        label="Προιοντα"
        title={<span className="text-[1.5rem] sm:text-[2rem] lg:text-[2.5rem]">Ένα εστιασμένο χαρτοφυλάκιο. Κάθε προϊόν υποστηρίζεται πλήρως.</span>}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            ...
            <div className="lg:col-span-2 flex flex-col gap-4">
              ...
              <div className="bg-light-grey rounded-brand border border-deep-blue/8 p-7">
                ...
                <p className="text-[0.875rem] text-slate-blue">Πλήρης αξιολόγηση κάθε παραγωγού/προμηθευτή πριν την ένταξη προϊόντων στο χαρτοφυλάκιο της Cuvon</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <CtaSection
        headline="Ας μιλήσουμε για την εμπορική δυναμική των προϊόντων στην Ελλάδα."
        sub="Πείτε μας για το προϊόν σας. Θα σας πούμε αν υπάρχει εμπορική εφαρμογή."

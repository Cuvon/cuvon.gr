  ...
  return (
    <>
      <PageHeader
        ...
        title="Ο αξιόπιστος εφοδιασμός ως κύριο επιχειρησιακό αγαθό"
        lead="Η υποδομή μας εξαλείφει τον κίνδυνο, διασφαλίζει τη συμμόρφωση και εγγυάται τη διαθεσιμότητα προϊόντων."
      />
      ...
      <section className="bg-white section-pad">
        <div className="site-container">
          <div className="section-header">
            ...
            <h2 className="text-h2 text-deep-blue mt-5">Παγκόσμιας κλάσης εγκαταστάσεις.</h2>
            <p className="text-lead text-slate-blue mt-4 max-w-2xl leading-[1.7]">
              Οι λειτουργίες logistics μας εδρεύουν στη Seneka — ένα από τα πιο προηγμένα κέντρα αποθήκευσης και διανομής της Ελλάδας, στην Αθήνα. Η εγκατάσταση παρέχει την κλίμακα, την ακρίβεια και τους περιβαλλοντικούς ελέγχους που απαιτεί το εύρος των δραστηριοτήτων μας.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="bg-light-grey rounded-brand p-7">
                ...
                <p className="text-[0.9375rem] text-slate-blue leading-[1.65] mb-4">
                  Εγκαταστάσεις αποθήκευσης τελευταίας τεχνολογίας στην Αθήνα. Αποθήκευση υψηλής χωρητικότητας, περιβάλλοντα ελεγχόμενης θερμοκρασίας και πλήρης υποδομή ιχνηλασιμότητας — ειδικά σχεδιασμένα για τη διανομή προϊόντων υγείας.
                </p>
              </div>
            </div>
          </div>

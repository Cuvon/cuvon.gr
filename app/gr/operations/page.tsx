            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="bg-light-grey rounded-brand p-7">
                ...
                <p className="text-[0.9375rem] text-slate-blue leading-[1.65] mb-4">
                  Εγκαταστάσεις αποθήκευσης τελευταίας τεχνολογίας στην Αθήνα. Αποθήκευση υψηλής χωρητικότητας, περιβάλλον ελεγχόμενης θερμοκρασίας και πλήρης υποδομή ιχνηλασιμότητας — ειδικά σχεδιασμένα για τη διανομή προϊόντων υγείας.
                </p>
              </div>
            </div>
          </div>

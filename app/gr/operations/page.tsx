        ...
        <div className="site-container">
          <div className="section-header">
            ...
            <p className="text-lead text-slate-blue mt-4 max-w-2xl leading-[1.7]">
              Οι λειτουργίες logistics μας εδρεύουν στη Seneka — ένα από τα πιο προηγμένα κέντρα αποθήκευσης και διανομής της Ελλάδας, στην Αθήνα. Η εγκατάσταση παρέχει την κλίμακα, την ακρίβεια και τους περιβαλλοντικούς ελέγχους που απαιτεί το εύρος των προϊόντων μας.
            </p>
          </div>

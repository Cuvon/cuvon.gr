  ...
  return (
    <>
      <PageHeader
        ...
        lead="Βλέπουμε την αξιοπιστία εφοδιαστικής αλυσίδας όχι απλώς ως επιχειρησιακό στόχο, αλλά ως την κύρια αξία που παρέχουμε στους συνεργάτες μας. Η υποδομή μας είναι χτισμένη για να εξαλείφει τον κίνδυνο, να διασφαλίζει τη συμμόρφωση και να εγγυάται τη διαθεσιμότητα προϊόντων χωρίς εξαιρέσεις."
      />

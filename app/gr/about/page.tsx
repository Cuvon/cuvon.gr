...
const pillars = [
  ...
  { num: '04', title: 'Φροντίδα στην πράξη',                     body: 'Η φροντίδα είναι επιχειρησιακή αρχή. Αξιολογούμε την Cuvon βάσει πραγματικών αποτελεσμάτων: εμπορική απόδοση, εφοδιαστική αξιοπιστία, διατήρηση συνεργατών, πρόσβαση ασθενών & καταναλωτών.' },
]
...
export default function GrAboutPage() {
  return (
    <>
      ...
      <section className="bg-deep-blue section-pad">
        <div className="site-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'Στους συνεργατες μας', body: 'Θα γνωρίζετε πάντα τι συμβαίνει επιχειρησιακά. Ο εφοδιασμός είναι σταθερός, οι αποφάσεις γρήγορες και τα προβλήματα επιλύονται άμεσα.' },
      ...
      <CtaSection
        headline="Αν υπάρχει κοινό εμπορικό έδαφος, δεν χάνουμε χρόνο."
        sub="Πείτε μας τι χρειάζεστε. Θα σας απαντήσουμε με σαφήνεια και ταχύτητα."

            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-deep-blue rounded-brand p-8 h-full flex flex-col justify-center">
                ...
                <p className="text-white/85 text-[0.9375rem] leading-[1.65]">
                  Η ομάδα μας κατανοεί το ρυθμιστικό πλαίσιο, τις απαιτήσεις logistics και τις εμπορικές σχέσεις εταίρων που καθορίζουν επιτυχία στην ελληνική αγορά υγείας.
                </p>
              </div>
            </div>
          </div>

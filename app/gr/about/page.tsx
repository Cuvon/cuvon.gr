          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            <div className="lg:col-span-3">
              ...
              <p className="text-lead text-slate-blue leading-[1.7] mb-5">
                Η Cuvon είναι εμπορικός συνεργάτης υγείας που δραστηριοποιείται στα φαρμακευτικά, OTC, συμπληρώματα διατροφής και καλλυντικά. Συνεργαζόμαστε άμεσα με κατασκευαστές, δίκτυα φαρμακείων και επαγγελματίες υγείας — διαχειριζόμενοι την πλήρη εφοδιαστική αλυσίδα από την εισαγωγή έως την παράδοση.
              </p>
            </div>

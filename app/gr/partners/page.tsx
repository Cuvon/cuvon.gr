...
const audience = [
  { title: 'Φαρμακοποιοί', body: 'Ισχυρή εμπορική πολιτική, σταθερά αποθέματα και ταχύς ανεφοδιασμός. Ενδυναμώνουμε τους φαρμακοποιούς να συνιστούν με σιγουριά και να αυξάνουν τον τζίρο.' },

...
const audience = [
  { title: 'Φαρμακοποιοί', body: 'Ισχυρή υποστήριξη προώθησης, σταθερά αποθέματα και ταχύς ανεφοδιασμός. Ενδυναμώνουμε τους φαρμακοποιούς να συνιστούν με σιγουριά και να αυξάνουν τον τζίρο.' },
  { title: 'Ιατροί', body: 'Εξειδικευμένη επικοινωνία που συνδέει προϊόντα με κορυφαίους επαγγελματίες υγείας. Στρατηγικές συμμόρφωσης για ισχυρή ιατρική υποστήριξη και σταθερή ανάπτυξη συνταγών.' },
...
export default function GrPartnersPage() {
  return (
    <>
      <PageHeader
        label="Συνεργατες"
        title="Συνεργασίες εμπιστοσύνης που στοχεύουν στην απόδοση."

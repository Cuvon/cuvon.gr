...
const audience = [
  { title: 'Φαρμακοποιοί', body: 'Σταθερά αποθέματα, ταχύς ανεφοδιασμός και ισχυρή υποστήριξη προώθησης. Ενδυναμώνουμε τους φαρμακοποιούς να συνιστούν με σιγουριά και να αυξάνουν τον τζίρο.' },

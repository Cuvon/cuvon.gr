...
const audience = [
  { title: 'Pharmacists', body: 'Strong promotional support, consistent stock, and rapid replenishment. We empower pharmacists to confidently recommend products and drive consumer trust.' },
